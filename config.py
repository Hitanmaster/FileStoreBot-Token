...
#Database 
DB_URI = "mongodb+srv://Himanshu:Himanshu0987@cluster0.7wked.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "7233389466").split()):
        ADMINS.append(int(x))
except ValueError:
